//-----------------------------------------------------------------------
// <copyright file="CRC32.cs" company="none">
// Copyright (c) kenny-nelson All Rights Reserved.
// </copyright>
//-----------------------------------------------------------------------

namespace Kiso.Security.Cryptography
{
    using System;
    ...
    public sealed class CRC32 : HashAlgorithm
    {
        ...
        /// <summary>
        /// ハッシュを計算するために、オブジェクトに書き込まれたデータをハッシュ アルゴリズムにルーティングします。
        /// </summary>
        ...
        protected override void HashCore(byte[] array, int ibStart, int cbSize)
        {
            unchecked
            {
                while (--cbSize >= 0)
                {
                    this.value = Table[(this.value ^ array[ibStart++]) & 0xFF] ^ (this.value >> 8);
                }
            }
        }

        /// <summary>
        /// 暗号ストリーム オブジェクトによって最後のデータが処理された後に、ハッシュ計算を終了します。
        /// </summary>
